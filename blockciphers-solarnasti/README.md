...
**Режим CBC должен быть выполнен с использованием `PKCS7` дополнения, режимы  CFB, OFB, CTR - без паддинга (`NON`), путём обрасывания лишных битов гаммы.**
